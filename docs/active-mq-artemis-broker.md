...
Apart from using the simple ActiveMQ-7 MQTT instance available in the [Simple Artemis MQTT Broker Service](./simple-artemis-mqtt-broker.md), this service allows to configure, in a more detailed way, the characteristics of the [ActiveMQ-7 broker](https://activemq.apache.org/artemis/index.html) instance running in Kura.
...
Please refer to the [official documentation](https://activemq.apache.org/components/artemis/documentation/latest/configuration-index.html#the-core-configuration) for more details on how to configure the ActiveMQ broker service.
